...
public class Exam extends JFrame implements ActionListener {
	...
	static String[] Option1;// =new
							// String[]{"op11","op12","op13","op14","op12","op13","op14","op12","op13","op14","4"};
	static String[] Option2;// =new
							// String[]{"op21","op22","op23","op24","op22","op23","op24","op22","op23","op24","4"};
	static String[] Option3;// =new
							// String[]{"op31","op32","op33","op34","op32","op33","op34","op32","op33","op34","4"};
	static String[] Option4;// =new
							// String[]{"op41","op42","op43","op44","op42","op43","op44","op42","op43","op44","4"};
	...
	private void initialize() throws SQLException {
		...
		query = "SELECT qid,qquestion,qop1,qop2,qop3,qop4,qcorrect_answer FROM question WHERE qid in (SELECT qid FROM examquestiontable WHERE eid="
				+ EID + ")";
		try {
			ResultSet r = Database.execute(query);
			int index = 0;
