...
public class ExamRightPanel extends JPanel implements ActionListener {
	...
	public static void calculate() {
		...
		for (int i = 0; i <= Exam.n; i++) {
			if (optionChossen[i] != null) {
				...
				System.out.println("optionChoosen[" + i + "] = " + optionChossen[i] + "correctOptions[" + i + "]"
						+ Exam.correctOptions[i]);
		...
		// System.out.println("qAttempted:"+questionsAttempted+"
		// "+"correct="+correctAnswers+" totalMarks: "+totalMarks);
		// return list;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == next) {
			...
			if (optionChossen[count] != null) {
				if (optionChossen[count].equals("1"))
					Opt1.setSelected(true);
				if (optionChossen[count].equals("2"))
					Opt2.setSelected(true);
				if (optionChossen[count].equals("3"))
					Opt3.setSelected(true);
				if (optionChossen[count].equals("4"))
			...
			if (pcount >= 0) {
				...
				if (optionChossen[pcount] != null) {
					...
					if (optionChossen[pcount].equals("1"))
						Opt1.setSelected(true);
					if (optionChossen[pcount].equals("2"))
						Opt2.setSelected(true);
					if (optionChossen[pcount].equals("3"))
						Opt3.setSelected(true);
					if (optionChossen[pcount].equals("4"))
						Opt4.setSelected(true);
				}
	...
	public void actionPerformedFromLeftPanel(int i) {
		...
		if (optionChossen[i - 1] != null) {
			if (optionChossen[i - 1].equals("1"))
				Opt1.setSelected(true);
			if (optionChossen[i - 1].equals("2"))
				Opt2.setSelected(true);
			if (optionChossen[i - 1].equals("3"))
				Opt3.setSelected(true);
			if (optionChossen[i - 1].equals("4"))
				Opt4.setSelected(true);
		}
	}
