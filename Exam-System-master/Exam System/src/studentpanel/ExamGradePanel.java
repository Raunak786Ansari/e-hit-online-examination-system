...
public class ExamGradePanel extends JPanel implements ActionListener {
	...
	public static void data(String m, String c, String q) {
		...
		query = "INSERT INTO examstudenttable VALUES('" + Exam.estid + "','" + Exam.EID + "','" + Dashboard.sid + "','"
				+ Exam.dateTimeStamp + "')";
		...
		query = "INSERT into result VALUES('" + Exam.estid + "','" + Exam.n + "','" + Exam.questionsAttempted + "','"
				+ Exam.correctAnswers + "','" + Exam.MarksObtained + "','" + Exam.totalMarks + "')";
		try {
			Database.executeUpdate(query);
