...
class dbConnector {
	...
	static final String db_url = "jdbc:mysql://127.0.0.1:3306/examsystem";
	// static final String db_url = "jdbc:mysql://localhost/examsystem";
	static String user = "root", pass = "Maakapyaar@123";
	...
	public static void main(String[] args) {
		...
		try {
			...
			String qry;
			// qry = "SHOW TABLES";
			qry = "SELECT last_name FROM student";
		...
		} catch (SQLException e) {// Exceptions in JDBC
			System.err.println("Exception  " + e.getMessage());
		} catch (Exception e) {// Exceptions in Class.forName()
			System.err.println("Exception  " + e.getMessage());
		} finally {
