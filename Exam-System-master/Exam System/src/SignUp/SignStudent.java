...
class MyFrame extends JFrame {
  ...
  MyFrame(int choice) {
    ...
    // System.out.println("Press: 1 for Student Signup and Press: 2 for Instructor
    // Signup");
...
class MyJpanel extends JPanel implements MouseListener, ActionListener, ItemListener, KeyListener// ash
{
  ...
  public static String firstName, lastName, dob, gender = "", address, pinCode, phoneNo, emailId, instituteName, branch,
      sem, year, scholarNo;// ashu
  MyJpanel inner;
  int i;
  int x = 0;
  int temp = 0;
  ...
  MyJpanel(Container ct) {
    ...
    jtf[0].setBounds((int) (scr.width / 2.6), (int) (scr.height / 8.3), (int) (scr.width / 9.6),
        (int) (scr.height / 36)); // text field f name
    jl[0].setBounds((int) (scr.width / 2.37), (int) (scr.height / 54), (int) (scr.width / 3.2),
        (int) (scr.height / 21.6)); // sign up
    jl[2].setBounds((int) (scr.width / 2), (int) (scr.height / 25.1), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4)); // last name
    jl[1].setBounds((int) (scr.width / 3.37), (int) (scr.height / 25.1), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4)); // first name
    jl[6].setBounds((int) (scr.width / 3.37), (int) (scr.height / 12), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4)); // dob
    jl[14].setBounds((int) (scr.width / 4.57), (int) (scr.height / 108), (int) (scr.width / 6.4),
        (int) (scr.height / 5.4)); // personal details
    jtf[1].setBounds((int) (scr.width / 1.66), (int) (scr.height / 8.3), (int) (scr.width / 9.6),
        (int) (scr.height / 36)); // text field l name
    jtf[2].setBounds((int) (scr.width / 2.6), (int) (scr.height / 6.17), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// dob t field
    jl[11].setBounds((int) (scr.width / 2), (int) (scr.height / 12), (int) (scr.width / 9.6), (int) (scr.height / 5.4));// gender
    jl[17].setBounds((int) (scr.width / 1.61), (int) (scr.height / 7.45), (int) (scr.width / 21.3),
        (int) (scr.height / 12));// male
    jl[18].setBounds((int) (scr.width / 1.47), (int) (scr.height / 7.45), (int) (scr.width / 21.3),
        (int) (scr.height / 12));// female
    jl[19].setBounds((int) (scr.width / 1.33), (int) (scr.height / 7.45), (int) (scr.width / 21.3),
        (int) (scr.height / 12));// others
    jl[15].setBounds((int) (scr.width / 3.37), (int) (scr.height / 8), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// address
    jtf[7].setBounds((int) (scr.width / 2.6), (int) (scr.height / 4.9), (int) (scr.width / 2.46),
        (int) (scr.height / 36));// address
    jl[9].setBounds((int) (scr.width / 3.37), (int) (scr.height / 6), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// pincode
    jtf[3].setBounds((int) (scr.width / 2.6), (int) (scr.height / 4.07), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// pincode
    jl[12].setBounds((int) (scr.width / 2), (int) (scr.height / 6), (int) (scr.width / 9.6), (int) (scr.height / 5.4));// contact
                                                                                                                       // no.
    jtf[4].setBounds((int) (scr.width / 1.66), (int) (scr.height / 4.1), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// contact number
    jl[8].setBounds((int) (scr.width / 3.37), (int) (scr.height / 4.7), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// emaili id
    jtf[9].setBounds((int) (scr.width / 2.6), (int) (scr.height / 3.48), (int) (scr.width / 4.26),
        (int) (scr.height / 36));// email.id
    jl[13].setBounds((int) (scr.width / 4.57), (int) (scr.height / 3.86), (int) (scr.width / 6.4),
        (int) (scr.height / 5.4));// academic details
    jl[10].setBounds((int) (scr.width / 3.37), (int) (scr.height / 3.45), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// institute
    jl[3].setBounds((int) (scr.width / 3.37), (int) (scr.height / 3.02), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// branch
    jl[5].setBounds((int) (scr.width / 3.37), (int) (scr.height / 2.68), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// year
    jl[4].setBounds((int) (scr.width / 2), (int) (scr.height / 3.02), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// semester
    jl[7].setBounds((int) (scr.width / 2), (int) (scr.height / 2.68), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// scholar number
    jtf[5].setBounds((int) (scr.width / 1.66), (int) (scr.height / 2.2), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// scholar number
    jtf[8].setBounds((int) (scr.width / 2.6), (int) (scr.height / 2.7), (int) (scr.width / 2.46),
        (int) (scr.height / 36));// institute name
    jcb1.setBounds((int) (scr.width / 1.66), (int) (scr.height / 2.43), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// semester
    jcb2.setBounds((int) (scr.width / 2.6), (int) (scr.height / 2.43), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// branch
    ...
    jl[20].setBounds((int) (scr.width / 2.3), (int) (scr.height / 1.75), (int) (scr.width / 3.84),
        (int) (scr.height / 36));// terms and conditions
    j.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.59), (int) (scr.width / 9.6),
        (int) (scr.height / 21.6));// j button submit
    j2.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.86), (int) (scr.width / 9.6),
        (int) (scr.height / 21.6));// Confirm button
    j1.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.59), (int) (scr.width / 9.6),
        (int) (scr.height / 21.6));// j1 back button
    imagelabel.setBounds((int) (scr.width / 1.6), (int) (scr.height / 3.48), (int) (scr.width / 10),
        (int) (scr.height / 36));// image label
    jb.setBounds((int) (scr.width / 1.4) + 170, (int) (scr.height / 3.48) + 50, (int) (scr.width / 15) + 30,
        (int) (scr.height / 33));// upload button
    jdp.setBounds((int) (scr.width / 1.19), (int) (scr.height / 6), (int) (scr.width / 14), (int) (scr.height / 7));// Desktop
                                                                                                                    // Pane
  ...
  public void mouseClicked(MouseEvent m) {
    if (m.getSource() == jl[20]) {
      ...
      ans = JOptionPane.showConfirmDialog(null,
          "1)Use of Mobile Phones is strictly Prohibited\n2)Be aware of Submit Button\n3)All Questions are Compulsory\n4)In academic details use college id no. for scholar number\n5)Correct answer will lead to +4 marks and wrong will lead to -1 marks",
          "Terms And Conditions", JOptionPane.YES_NO_OPTION);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals("Upload Image")) {
      ...
      try {
        ...
        Toolkit tk = Toolkit.getDefaultToolkit();
        Dimension scr = tk.getScreenSize();
        image2.setBounds((int) (scr.width / 1.17), (int) (scr.height / 6), (int) (scr.width / 14),
            (int) (scr.height / 7));
        add(image2);
      } catch (Exception exc) {
    ...
    if (e.getActionCommand().equals("SUBMIT")) {
      if (temp % 2 == 0) {
        JOptionPane.showMessageDialog(null, "Please Check out terms and Conditions", "ERROR!",
        ...
        if (size > 40000 || filename == null || phoneNo.length() != 10 || pinCode.length() != 6 || firstName.equals("")
            || lastName.equals("") || dob.equals("") || gender.equals("") || address.equals("") || pinCode.equals("")
            || phoneNo.equals("") || emailId.equals("") || instituteName.equals("") || scholarNo.equals("")
            || branch.equals("") || year.equals("") || sem.equals(""))//
        {
          if (firstName.equals("") || lastName.equals("") || dob.equals("") || gender.equals("") || address.equals("")
              || pinCode.equals("") || phoneNo.equals("") || emailId.equals("") || instituteName.equals("")
              || scholarNo.equals("") || branch.equals("") || year.equals("") || sem.equals(""))//
          ...
          if (phoneNo.length() != 10) {
            JOptionPane.showMessageDialog(null, "Phone Number Must Be Of 10 Digits", "ERROR!",
                JOptionPane.ERROR_MESSAGE);
          }
          if (filename == null) {
          ...
          // ashu
          if (image2 != null) {
            mjp2.image2.setBounds((int) (scr.width / 1.17), (int) (scr.height / 6), (int) (scr.width / 14),
                (int) (scr.height / 7));
            mjp2.add(image2);
          }
  ...
  public void keyReleased(KeyEvent k) {
    if (k.getSource() == jtf[0]) {
      if (k.getKeyChar() == '0' || k.getKeyChar() == '1' || k.getKeyChar() == '2' || k.getKeyChar() == '3'
          || k.getKeyChar() == '4' || k.getKeyChar() == '5' || k.getKeyChar() == '6' || k.getKeyChar() == '7' ||
          k.getKeyChar() == '8' || k.getKeyChar() == '9' || k.getKeyChar() == '~' || k.getKeyChar() == '`'
          || k.getKeyChar() == '!' || k.getKeyChar() == '@' || k.getKeyChar() == '#' || k.getKeyChar() == '$'
          || k.getKeyChar() == '%' || k.getKeyChar() == '^' || k.getKeyChar() == '&' || k.getKeyChar() == '*'
          || k.getKeyChar() == '(' || k.getKeyChar() == ')' || k.getKeyChar() == '_' || k.getKeyChar() == '-'
          || k.getKeyChar() == '+' ||
          k.getKeyChar() == '=' || k.getKeyChar() == '{' || k.getKeyChar() == '[' || k.getKeyChar() == '}'
          || k.getKeyChar() == ']' || k.getKeyChar() == ':' || k.getKeyChar() == ';' || k.getKeyChar() == '"'
          || k.getKeyChar() == '<' || k.getKeyChar() == '>' || k.getKeyChar() == ',' || k.getKeyChar() == '.'
    ...
    if (k.getSource() == jtf[7]) {
      if (k.getKeyChar() == '~' || k.getKeyChar() == '`' || k.getKeyChar() == '!' || k.getKeyChar() == '@'
          || k.getKeyChar() == '#' || k.getKeyChar() == '$' || k.getKeyChar() == '%' || k.getKeyChar() == '^'
          || k.getKeyChar() == '*' || k.getKeyChar() == '_' || k.getKeyChar() == '+' || k.getKeyChar() == '='
          || k.getKeyChar() == '{' || k.getKeyChar() == '[' || k.getKeyChar() == '}' || k.getKeyChar() == ']'
          || k.getKeyChar() == ';' ||
          k.getKeyChar() == '<' || k.getKeyChar() == '>' || k.getKeyChar() == '?' || k.getKeyChar() == '\\'
          || k.getKeyChar() == '|') {
    ...
    if (k.getSource() == jtf[3]) {
      ...
      if (str4.length() < 7) {
        if (k.getKeyChar() == ' ' || k.getKeyChar() == 'a' || k.getKeyChar() == 'b' || k.getKeyChar() == 'c'
            || k.getKeyChar() == 'd' || k.getKeyChar() == 'e' || k.getKeyChar() == 'f' || k.getKeyChar() == 'g'
            || k.getKeyChar() == 'h' || k.getKeyChar() == 'i' || k.getKeyChar() == 'j' || k.getKeyChar() == 'k'
            || k.getKeyChar() == 'l' || k.getKeyChar() == 'm' || k.getKeyChar() == 'n' || k.getKeyChar() == 'o'
            || k.getKeyChar() == 'p' ||
            k.getKeyChar() == 'q' || k.getKeyChar() == 'r' || k.getKeyChar() == 's' || k.getKeyChar() == 't'
            || k.getKeyChar() == 'u' || k.getKeyChar() == 'v' || k.getKeyChar() == 'w' || k.getKeyChar() == 'x'
            || k.getKeyChar() == 'y' || k.getKeyChar() == 'z' || k.getKeyChar() == 'A' || k.getKeyChar() == 'B'
            || k.getKeyChar() == 'C' || k.getKeyChar() == 'D' || k.getKeyChar() == 'E' || k.getKeyChar() == 'F'
            || k.getKeyChar() == 'G' ||
            k.getKeyChar() == 'H' || k.getKeyChar() == 'I' || k.getKeyChar() == 'J' || k.getKeyChar() == 'K'
            || k.getKeyChar() == 'L' || k.getKeyChar() == 'M' || k.getKeyChar() == 'N' || k.getKeyChar() == 'O'
            || k.getKeyChar() == 'P' || k.getKeyChar() == 'Q' || k.getKeyChar() == 'R' || k.getKeyChar() == 'S'
            || k.getKeyChar() == 'T' || k.getKeyChar() == 'U' || k.getKeyChar() == 'V' || k.getKeyChar() == 'W'
            || k.getKeyChar() == 'X' ||
            k.getKeyChar() == 'Y' || k.getKeyChar() == 'Z' || k.getKeyChar() == '~' || k.getKeyChar() == '`'
            || k.getKeyChar() == '!' || k.getKeyChar() == '@' || k.getKeyChar() == '#' || k.getKeyChar() == '$'
            || k.getKeyChar() == '%' || k.getKeyChar() == '^' || k.getKeyChar() == '&' || k.getKeyChar() == '*'
            || k.getKeyChar() == '(' || k.getKeyChar() == ')' || k.getKeyChar() == '_' || k.getKeyChar() == '-'
            || k.getKeyChar() == '+' ||
...
class Signinst extends JPanel implements ActionListener, MouseListener, ItemListener, KeyListener {
  ...
  public static String firstName, lastName, dob, gender = "", address, pinCode, phoneNo, emailId, instituteName,
  ...
  Signinst(Container ct) {
    ...
    jl[7].setBounds((int) (scr.width / 2), (int) (scr.height / 3.02), (int) (scr.width / 9.6),
        (int) (scr.height / 5.4));// scholar number
    jtf[5].setBounds((int) (scr.width / 1.66), (int) (scr.height / 2.43), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// scholar number
    jtf[8].setBounds((int) (scr.width / 2.6), (int) (scr.height / 2.7), (int) (scr.width / 2.46),
        (int) (scr.height / 36));// institute name
    jcb1.setBounds((int) (scr.width / 2.6), (int) (scr.height / 2.43), (int) (scr.width / 9.6),
        (int) (scr.height / 36));// semester
    ...
    jl[20].setBounds((int) (scr.width / 2.3), (int) (scr.height / 2.09), (int) (scr.width / 3.84),
        (int) (scr.height / 36));// terms and conditions
    j.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.86), (int) (scr.width / 9.6),
        (int) (scr.height / 21.6));// j button submit
    j2.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.86), (int) (scr.width / 9.6),
        (int) (scr.height / 21.6));// Confirm button
    j1.setBounds((int) (scr.width / 2.18), (int) (scr.height / 1.59), (int) (scr.width / 9.6),
    ...
    imagelabel.setBounds((int) (scr.width / 1.6), (int) (scr.height / 3.48), (int) (scr.width / 10),
        (int) (scr.height / 36));// image label
    jb.setBounds((int) (scr.width / 1.4), (int) (scr.height / 3.48), (int) (scr.width / 15), (int) (scr.height / 33));// upload
                                                                                                                      // button
    jdp.setBounds((int) (scr.width / 1.19), (int) (scr.height / 6), (int) (scr.width / 14), (int) (scr.height / 7));// Desktop
                                                                                                                    // Pane
    image1.setBounds((int) (scr.width / 1.17), (int) (scr.height / 6), (int) (scr.width / 14), (int) (scr.height / 7));
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals("SUBMIT")) {
      if (temp % 2 == 0) {
        ...
        if (size > 40000 || filename == null || phoneNo.length() != 10 || pinCode.length() != 6 || firstName.equals("")
            || lastName.equals("") || dob.equals("") || gender.equals("") || address.equals("") || pinCode.equals("")
            || phoneNo.equals("") || emailId.equals("") || instituteName.equals("") || department.equals("")
            || instructorId.equals("")) {
          if (firstName.equals("") || lastName.equals("") || dob.equals("") || gender.equals("") || address.equals("")
              || pinCode.equals("") || phoneNo.equals("") || emailId.equals("") || instituteName.equals("")
              || department.equals("") || instructorId.equals("")) {
            JOptionPane.showMessageDialog(null, "All Fields must be Filled", "ERROR!", JOptionPane.ERROR_MESSAGE);
          }
          if (pinCode.length() != 6) {
            JOptionPane.showMessageDialog(null, "Pin Code Must Be Of 6 Digits", "ERROR!", JOptionPane.ERROR_MESSAGE);
          ...
          if (image2 != null) {
            mjp2.image2.setBounds((int) (df.width / 1.17), (int) (df.height / 6), (int) (df.width / 14),
                (int) (df.height / 7));
            mjp2.add(image2);
          }
          mjp2.jb.setVisible(false);
