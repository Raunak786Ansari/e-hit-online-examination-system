...
public class ExamEvaluation extends JPanel implements ItemListener {
	...
	public void createList() {
		...
		String papers[] = { "Paper 1 ", "Paper 2", "Paper 3" }; // Replace this with string of papers recieved from
																// database
		int l = papers.length;
		for (int i = 0; i < l; i++)
			list.add(papers[i]);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		// Create Object Of Evaluate which will take as input the paper and will display
