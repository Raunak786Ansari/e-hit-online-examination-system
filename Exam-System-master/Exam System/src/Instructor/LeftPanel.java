...
public class LeftPanel extends JPanel {
	...
	void createGUI() {
		...
		lo2.setBounds(0, 50 + label_height + label_shift * flag + 5 * flag + (label_height + 2), label_width - 60 + 40,
				label_height);
		l3.setBounds(0, 50 + label_height + 2 * label_shift * flag + 15 * flag + 5 + (label_height + 5),
				label_width - 40 + 20, label_height);
		l4.setBounds(0, 50 + label_height + 2 * label_shift * flag + 15 * flag + 5 + 2 * (label_height + 5),
				label_width - 40 + 20, label_height);
		 ...
		 * lo2.setBounds(30,50+label_shift*flag+1*flag+(label_height+2),label_width-60,
		 * label_height);
		 * l2.setBounds(20,50+2*label_shift*flag+15*flag+(label_height+5),label_width-40
		 * ,label_height);
		 * l3.setBounds(20,50+2*label_shift*flag+15*flag+2*(label_height+5),label_width-
		 * 40,label_height);
		 * l4.setBounds(20,50+2*label_shift*flag+15*flag+3*(label_height+5),label_width-
		 * 40,label_height);
		 */
