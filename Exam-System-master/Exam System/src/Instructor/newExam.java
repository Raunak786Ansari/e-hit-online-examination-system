...
public class newExam extends JPanel {
	...
	int askType() {
		...
		// int choice = JOptionPane.showOptionDialog(this, "Select Type Of Question ",
		// "", 1, 1, null,type, "");
		int choice = 0;
	...
	void viewQuestion() {
		...
		// p.showMessageDialog(this,q[item].getQuestion(),"Question
		// "+q[item].getQuestionId(),1); //set icon for this
