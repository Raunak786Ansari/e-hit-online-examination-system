...
public class ExamDetails extends JFrame {
	...
	int fetchGroups() {
		...
		String s = (String) JOptionPane.showInputDialog(this, "Select Group : ", "", JOptionPane.PLAIN_MESSAGE, null,
				gid, "");
	...
	class eventAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == (Object) date) {
				...
				newExam.exam.setDateTime(
						ldate.getText() + " " + hh.getValue().toString() + "-" + mm.getValue().toString() + "-00");
