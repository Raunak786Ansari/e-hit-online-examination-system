...
class MyJpanel extends JPanel implements MouseListener, ActionListener, ItemListener {
  ...
  public static String firstName, lastName, dob, gender, address, pinCode, phoneNo, emailId, instituteName, branch, sem,
      year, scholarNo;
  MyJpanel inner;
  int i;
  int x = 0;
  ...
  MyJpanel(Container ct) {
    ...
    imagelabel.setBounds((int) (scr.width / 1.6) + 150, (int) (scr.height / 3.48), (int) (scr.width / 10),
        (int) (scr.height / 36));// image label
    jb.setBounds((int) (scr.width / 1.4) + 140, (int) (scr.height / 3.48) + 50, (int) (scr.width / 15) + 50,
...
class Signinst extends JPanel implements ActionListener, MouseListener, ItemListener {
  ...
  public static String firstName, lastName, dob, gender, address, pinCode, phoneNo, emailId, instituteName, department,
      instructorId;
